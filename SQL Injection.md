...
- [SQL injection attack, querying the database type and version on Oracle. SQL injection attack, querying the database type and version on MySQL and Microsoft](#sql-injection-attack-querying-the-database-type-and-version-on-oracle-sql-injection-attack-querying-the-database-type-and-version-on-mysql-and-microsoft)
	- [MySQL](#mysql)
		- [1. First of all you have to know the quantities of columns in the table](#1-first-of-all-you-have-to-know-the-quantities-of-columns-in-the-table)
		- [2. Obtain the database names](#2-obtain-the-database-names)
		- [3. Obtain the tables of a database](#3-obtain-the-tables-of-a-database)
		- [4. Obtain the columns](#4-obtain-the-columns)
		- [5. Obtain the data](#5-obtain-the-data)
	- [Oracle](#oracle)
...
- [SQL injection with out-of-band interaction | SQL injection OOB](#sql-injection-with-out-of-band-interaction--sql-injection-oob)
